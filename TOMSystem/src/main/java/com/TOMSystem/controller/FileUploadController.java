...
public class FileUploadController {
	...
	public String addSelectedItem(@RequestBody String item_id, Map<String, Object> map,HttpServletRequest request){
		if(request.getAttribute("userId")=="admin")
		{
	...
	public String uploadFileHandler(@RequestParam("item_name") String item_name,
			...
			@RequestParam("item_prep_time") int item_prep_time, Map<String, Object> map,HttpServletRequest request) {
	...
	public String setupRemoveForm(Map<String, Object> map,HttpServletRequest request){
		if(request.getAttribute("userId")=="admin")
		{
			Item item= new Item();
			map.put("item", item);
	...
	public String removeSelectedItem(@RequestBody String item_id, Map<String, Object> map,HttpServletRequest request){
		if(request.getAttribute("userId")=="admin")
		{
			Item tempItem = itemService.getItem(Integer.valueOf(item_id));
	...
	public String setupItemsForm(Map<String, Object> map,HttpServletRequest request){

		if(request.getAttribute("userId")!=null && request.getAttribute("userId")!="admin")
		{
			Item item= new Item();
	...
	public String removeItemFromCart(@RequestBody String item_id, Map<String, Object> map, HttpSession sessionObj,HttpServletRequest request){
	...
	public String addItemToCart(@RequestBody String item_id, Map<String, Object> map, HttpSession sessionObj,HttpServletRequest request){
		if(request.getAttribute("userId")!=null &&request.getAttribute("userId")!="admin")
		{
			Item tempItem = itemService.getItem(Integer.valueOf(item_id));
			System.out.println(item_id+"**********************************\n"+tempItem);
